...
function init(b) {
	...
	if (b) {
		$("#pauseBtn").attr('src',"https://drive.google.com/uc?id=1Wb1QTxqa-OF515QrCNus5vJ0X37B4RbH");
...
function showHelp() {
	if ($('#openSideBar').attr('src') == 'https://drive.google.com/uc?id=1kPgnXCdvg54tfcBd8DS1nA3wgsek8JAt') {
		$('#openSideBar').attr('src', 'https://drive.google.com/uc?id=1OnZw3letLvrYk-PVSrS16ueYtM-9uote ');
		if (gameState != 0 && gameState != -1 && gameState != 2) {
			$('#fork-ribbon').fadeOut(150, 'linear');
		}
	} else {
		$('#openSideBar').attr('src', 'https://drive.google.com/uc?id=1kPgnXCdvg54tfcBd8DS1nA3wgsek8JAt');
		if (gameState == 0 && gameState == -1 && gameState == 2) {
	...
	if($("#pauseBtn").attr('src') == "https://drive.google.com/uc?id=1Wb1QTxqa-OF515QrCNus5vJ0X37B4RbH" && gameState != 0 && !infobuttonfading) {
		return;
	}
